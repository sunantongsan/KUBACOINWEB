...
import { Rocket, Calendar, Users, Target } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-slideUp">
      <div className="flex justify-between items-end">
        ...
        <button className="bg-yellow-500 hover:bg-yellow-400 text-slate-900 font-bold px-6 py-3 rounded-xl shadow-lg shadow-yellow-500/20 flex items-center gap-2">
            <Rocket size={18} /> Create Presale
        </button>
      </div>
